                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('employees.travel.show', $travel) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                            @if($travel->status == 'pending')
                            <form action="{{ route('employees.travel.destroy', $travel) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to cancel this travel authority?')">Cancel</button>
                            </form>
                            @endif
                        </td>
                    </tr>

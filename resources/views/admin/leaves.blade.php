                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-800">Travel Itinerary</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-yellow-700 mt-2 space-y-1">
                                    <li>• Applications require supervisor approval</li>
                                    <li>• Submit at least 3 working days in advance for vacation leave</li>
                                    <li>• Sick leave requires medical certificate if more than 3 days</li>
                                    <li>• You will receive email notification once processed</li>
                                    <li>• Approval may take 2-3 working days</li>
                                </ul>
                            </div>
                        </div>
                    </div>
